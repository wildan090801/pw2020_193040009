...
<body>
  ...
  <form action="" method="POST">
    ...
    <ul>
      ...
      <input type="text" name="Alat_musik" id="Alat_musik" required value="<?= $am['Alat_musik']; ?>"><br><br>

      <li><label for="Merk">Merk : </label></li>
      <input type="text" name="Merk" id="Merk" required value="<?= $am['Merk']; ?>"><br><br>

      <li><label for="Cara_bermain">Cara Bermain : </label><br>
        <select name="Cara_bermain" id="Cara_bermain" required value="<?= $am['Cara_bermain']; ?>">
      ...
      <input type="text" name="Harga" id="Harga" required value="<?= $am['Harga']; ?>"><br><br>
